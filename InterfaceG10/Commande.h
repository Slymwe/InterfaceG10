#pragma once
#include "COAfficher.h"
#include "COModifier.h"
#include "COSupprimer.h"
#include "COCrée.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(133, 302);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(315, 302);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(500, 302);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(685, 302);
			...
			this->ClientSize = System::Drawing::Size(925, 485);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		COAfficher^ p = gcnew COAfficher;
		this->Hide();
		p->Show();

	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		COModifier^ m = gcnew COModifier;
		this->Hide();
		m->Show();

	}
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		COSupprimer^ ps = gcnew COSupprimer;
		this->Hide();
		ps->Show();
	}
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		COCrée^ c = gcnew COCrée;
		this->Hide();
		c->Show();
	}
};
